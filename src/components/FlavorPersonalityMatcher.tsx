 ...
 import { Sparkles, ChevronRight, Pizza, RotateCcw, Share2 } from 'lucide-react';
       ...
       <div className="container-main px-4">
         <div className="text-center mb-12">
           ...
           <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
             Answer 5 fun questions and let our AI reveal your unique flavor profile!
           </p>
         </div>
             ...
             {!isStarted && !result && (
               ...
               >
                 ...
                 <p className="text-muted-foreground mb-8">
                   ...
                   Answer honestly and discover the pizza that was made for YOU.
                 </p>
                 <button
